...
tcumsum = lambda x: tcumsum(x, dim=0)
...
def numpyro():
    global tensor, dtype_float, dtype_long, ones, array
    ...
    global log_sum_exp_real_real
    from jax.numpy import logaddexp as log_sum_exp_real_real
    ...
    global rep_matrix_vector_int
    rep_matrix_vector_int = lambda v, n: tile(transpose(array([v])), (1, n))

    global rep_matrix_rowvector_int
    ...
    global append_col_rowvector_real, append_col_rowvector_int
    ...
    global append_row_vector_real, append_row_vector_int
    ...
    global integrate_ode_rk45_array_real_array_array_array_array_real_real_int
    integrate_ode_rk45_array_real_array_array_array_array_real_real_int = (
